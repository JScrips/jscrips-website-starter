...
const contact = () => {
	return (
		<section className='relative dark:bg-neutral-800'>
			<HeroBanner>
				<h1 className='pt-8 text-5xl font-bold'>Contact</h1>
			</HeroBanner>

			<img
				className='absolute top-0 left-0 hidden w-2/5 lg:block'
				src='zospace-assets/images/map.svg'
				alt=''
			/>
			<img
				className='absolute top-0 left-0 mt-40 ml-40 hidden lg:block'
			...
			<div className='container relative mx-auto px-4 pt-20'>
				<div className='mb-20 text-center'>
					...
					<h2 className='font-heading mt-10 text-5xl font-bold text-white'>
						Contact with us
					</h2>
				</div>
				<div className='mx-auto max-w-4xl'>
					<div className='-mx-4 mb-20 flex flex-wrap'>
						<div className='mb-4 w-full px-4 lg:mb-0 lg:w-1/2'>
							<div className='rounded-b-lg bg-gray-600'>
								...
								<div className='px-14 py-8'>
									<div className='mb-6 bg-gray-500 py-px'></div>
									<h3 className='mb-8 text-xl font-bold text-white lg:mb-4'>
										Have any question? Send a message!
									</h3>
									<div className='md:text-right'>
										<a
											className='inline-block rounded-full border border-gray-300 px-12 py-4 font-bold text-white hover:border-gray-200'
											href='#'>
											Message
										</a>
									</div>
						...
						<div className='w-full px-4 lg:w-1/2'>
							<div className='mb-4 rounded-lg bg-gray-600 py-6 px-8'>
							...
							<div className='mb-10 rounded-lg bg-gray-600 py-6 px-8'>
								<div className='flex items-center'>
									<span className='mr-8 flex h-12 w-12 items-center justify-center rounded-lg bg-blue-500'>
										<svg
											className='h-3 w-5'
							...
							<div className='py-6 px-8'>
								<div className='flex'>
									...
									<div>
										<div className='mb-6 border-b border-gray-500 pb-4 pr-16'>
											<p className='text-lg font-bold text-white'>
												Bayswater, London
											</p>
											<p className='text-lg font-bold text-white'>W16EG, UK</p>
										</div>
